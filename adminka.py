...
BAD_WORDS = [
    'кунти', 'гандон', 'кси оча', 'кси апа', 'кси хола', 'модарта мег', 'сука', 'сучка', 'далбаёб', 
    'фуруши дорм', 'фуруши дорам', 'ки мехара', 'апата мег', 'отата мег', 'suka', 'su4ka',
    'мегом', 'ksti', 'o4ata m', 'apata m', 'керм', 'мехарм', 'мехарам', 'gom', 'гойда' 
]
